...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='divyanshu16/high-res-diffusion-model',
    ...
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default='/mnt/disks/persist/laion-super-resolution/train_data/images',
        help=(
    ...
    parser.add_argument(
        ...
        type=str,
        default="train_high_res_diff_flax",
...
def wds_dataset(data_folder: str, tokenizer, size: int = 512):
...
def main():
    ...
    # ==================
    # TODO: Replace pretrained unet and scheduler with paper suggested from scratch.
    # ==================
